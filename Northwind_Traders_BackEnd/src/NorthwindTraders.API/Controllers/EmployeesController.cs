...
public class EmployeesController : ControllerBase   // C# — base class for API controllers, no view support
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        {
            return StatusCode(500, $"An unexpected error occurred while retrieving employees: {ex.Message}");
        }
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        {
            return StatusCode(500, $"An unexpected error occurred while retrieving employee {id}: {ex.Message}");
        }
    }
    ...
    public async Task<IActionResult> Update(int id, UpdateEmployeeDto dto)
    {
        ...
        {
            return StatusCode(500, $"An unexpected error occurred while updating employee {id}: {ex.Message}");
        }
    }
}